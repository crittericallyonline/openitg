#ifndef __FAKEUSB_H__
#define __FAKEUSB_H__
...
struct PACKED usb_descriptor_header {
...
struct PACKED usb_dev_handle;
typedef struct PACKED usb_dev_handle usb_dev_handle;
